...
| **Victim MAC** | `80:86:5b:ab:1e:c4` | Physical address of the infected host |
| **User Account** | `rwalters` | Identified via Kerberos AS-REQ traffic |
...
| **Malicious Script** | `mystery_file.ps1` | PowerShell script initiating the infection |
| **Exfiltrated Data** | `Top_secret_ducment.docx` | Sensitive document stolen by the malware |
